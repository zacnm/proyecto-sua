...
public class TrafficJamTransitionAdaptationRule extends AdaptationRule {
	
	public static String ID = "Regla Transición a Traffic Jam";
	
	IKnowledgeProperty nivelAutonomiaKp = null;
	IKnowledgeProperty funcionConduccionKp = null;

	public TrafficJamTransitionAdaptationRule(BundleContext context) {
		super(context, ID);
	...
	public boolean checkAffectedByChange(IKnowledgeProperty property) {
		if (nivelAutonomiaKp == null || nivelAutonomiaKp.getValue() != ENivelAutonomia.L3_AutomatizacionCondicional ||
				funcionConduccionKp == null || funcionConduccionKp.getValue() != EFuncionConduccion.L3_TrafficJamChauffer) {
			return false;
		}
	...
	public IRuleSystemConfiguration onExecute(IKnowledgeProperty property) throws RuleException {
		...
		if (nivelAutonomia == ENivelAutonomia.L3_AutomatizacionCondicional && funcionConduccion == EFuncionConduccion.L3_TrafficJamChauffer) {
			...
			L3TrafficJamChaufferService.startDriving();
