...
import sua.autonomouscar.driving.l3.trafficjamchauffer.L3_TrafficJamChaufferARC;
...
public class TransitionCityToTrafficJamAdaptationRule extends AdaptationRule {
	
	protected static SmartLogger logger = SmartLogger.getLogger(TransitionCityToTrafficJamAdaptationRule.class);
	public static String ID = "Regla Transición Ciudad a Atasco";
	...
	public TransitionCityToTrafficJamAdaptationRule(BundleContext context) {
		super(context, ID);
	...
	public boolean checkAffectedByChange(IKnowledgeProperty property) {
		...
		return funcionConduccionAnterior == EFuncionConduccion.L3_CityChauffer &&
	...
	public IRuleSystemConfiguration onExecute(IKnowledgeProperty property) throws RuleException {
		...
		SystemConfigurationHelper.componentToRemove(nextSystemConfiguration, "driving.L3.CityChauffer", "1.0.0");
		...
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_ENGINE,
				"device.Engine", "1.0.0", EngineARC.PROVIDED_DEVICE);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_STEERING,
				"device.Steering", "1.0.0", SteeringARC.PROVIDED_DEVICE);

		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_ROADSENSOR,
				"device.RoadSensor", "1.0.0", RoadSensorARC.PROVIDED_SENSOR);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_FRONTDISTANCESENSOR,
				getDistanceSensorId(EDireccion.FRONT), "1.0.0", DistanceSensorARC.PROVIDED_SENSOR);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_LEFTDISTANCESENSOR,
				getDistanceSensorId(EDireccion.LEFT), "1.0.0", DistanceSensorARC.PROVIDED_SENSOR);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_REARDISTANCESENSOR,
				getDistanceSensorId(EDireccion.REAR), "1.0.0", DistanceSensorARC.PROVIDED_SENSOR);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_RIGHTDISTANCESENSOR,
				getDistanceSensorId(EDireccion.RIGHT), "1.0.0", DistanceSensorARC.PROVIDED_SENSOR);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_LEFTLINESENSOR,
				"device.LeftLineSensor", "1.0.0", LineSensorARC.PROVIDED_SENSOR);

		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_RIGHTLINESENSOR,
				"device.RightLineSensor", "1.0.0", LineSensorARC.PROVIDED_SENSOR);

		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_HUMANSENSORS,
				"device.HumanSensors", "1.0.0", HumanSensorsARC.PROVIDED_SENSOR);

		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_NOTIFICATIONSERVICE,
				"interaction.NotificationService", "1.0.0", NotificationServiceARC.PROVIDED_SERVICE);
		
		SystemConfigurationHelper.bindingToAdd(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_TrafficJamChaufferARC.REQUIRED_FALLBACKPLAN,
		...
		SystemConfigurationHelper.setParameter(nextSystemConfiguration, 
				"driving.L3.TrafficJamChauffer", "1.0.0", L3_DrivingServiceARC.PARAMETER_REFERENCESPEED, "100");
