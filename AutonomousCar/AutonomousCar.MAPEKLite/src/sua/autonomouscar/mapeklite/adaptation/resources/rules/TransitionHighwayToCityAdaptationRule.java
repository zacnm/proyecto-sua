...
public class TransitionHighwayToCityAdaptationRule extends AdaptationRule {
	
	protected static SmartLogger logger = SmartLogger.getLogger(TransitionHighwayToCityAdaptationRule.class);
	public static String ID = "Regla Transición Autopista a Ciudad";
	...
	public boolean checkAffectedByChange(IKnowledgeProperty property) {
		...
		logger.debug(String.format("%s, %s", kp_FuncionConduccionActual, kp_FuncionConduccionAnterior));
