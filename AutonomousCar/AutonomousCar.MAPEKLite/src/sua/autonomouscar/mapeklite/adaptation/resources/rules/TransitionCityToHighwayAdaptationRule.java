...
public class TransitionCityToHighwayAdaptationRule extends AdaptationRule {
	...
	protected static SmartLogger logger = SmartLogger.getLogger(TransitionCityToHighwayAdaptationRule.class);
	public static String ID = "Regla Transición Ciudad a Autopista";
	...
	public TransitionCityToHighwayAdaptationRule(BundleContext context) {
		super(context, ID);
